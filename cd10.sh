...
#git clone https://github.com/LineageOS/android_device_lge_msm8996-common -b lineage-21
wait_one_second && git clone https://github.com/xc112lg/android_device_lge_msm8996-common -b cd11 device/lge/msm8996-common
